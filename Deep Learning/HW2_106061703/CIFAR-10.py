# -*- coding: utf-8 -*-
"""
Created on Tue Nov 27 12:30:26 2018
...
with tf.name_scope('D_Flat'):
    D_Flat=tf.reshape(C2_Pool,[-1,4096])
...
plt.savefig('E:\Deep learning Eric\CIFAR10\Learning curve.png')
...
plt.xlabel('epoch')
plt.legend()
plt.savefig('E:\Deep learning Eric\CIFAR10\Acc.png')

#######
plt.figure()
plt.title('Histogram of conv1')
plt.hist(weight1.flatten())
plt.savefig('E:\Deep learning Eric\CIFAR10\conv1.png')


plt.figure()
plt.title('Histogram of conv2')
plt.hist(weight2.flatten())
plt.savefig('E:\Deep learning Eric\CIFAR10\conv2.png')


plt.figure()
plt.title('Histogram of dense1')
plt.hist(weight3.flatten())
plt.savefig('E:\Deep learning Eric\CIFAR10\dense1.png')


plt.figure()
plt.title('Histogram of output')
plt.hist(weight4.flatten())
plt.savefig('E:\Deep learning Eric\CIFAR10\output.png')
...
plt.figure()
plt.imshow(conv1[0,:,:,0],cmap='binary')

plt.figure()
plt.imshow(c1_pool[0,:,:,0],cmap='binary')

plt.figure()
plt.imshow(conv2[0,:,:,0],cmap='binary')

plt.figure()
plt.imshow(c2_pool[0,:,:,0],cmap='binary')
...
plt.figure()
plt.imshow(conv1[3,:,:,0],cmap='binary')

plt.figure()
plt.imshow(c1_pool[3,:,:,0],cmap='binary')

plt.figure()
plt.imshow(conv2[3,:,:,0],cmap='binary')

plt.figure()
plt.imshow(c2_pool[3,:,:,0],cmap='binary')
